...
#  let(:valid_attributes) { { "spacecraft_id" => "1" } }
#
...
#        post :create, {:subscription => { "spacecraft_id" => "invalid value" }}, valid_session
#        assigns(:subscription).should be_a_new(Subscription)
#      end
#
...
#        Subscription.any_instance.should_receive(:update).with({ "spacecraft_id" => "1" })
#        put :update, {:id => subscription.to_param, :subscription => { "spacecraft_id" => "1" }}, valid_session
#      end
#
#      it "assigns the requested subscription as @subscription" do
#        subscription = Subscription.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Subscription.any_instance.stub(:save).and_return(false)
#        put :update, {:id => subscription.to_param, :subscription => { "spacecraft_id" => "invalid value" }}, valid_session
#        assigns(:subscription).should eq(subscription)
#      end
#
